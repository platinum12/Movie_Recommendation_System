	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img src="assets/images/logo.jpg" alt="Progressus HTML5 template" width="50px"></a>
								...
								<div class="row">
									<div class="col-lg-8">
										<label class="checkbox">
											...
											I've read the <a href="page_terms.html">Terms and Conditions</a><br/>
										</label>    
